...
describe('InMemoryKV', () => {
    ...
    it('must be immutable with deep object', () => {
        ...
        const cloneDeepObj = _.cloneDeep(deepObj); // копия начального объекта
        const map = new InMemoryKV(deepObj); // создали новую БД из копии начального объекта

        const map2 = map.toObject(); // превратили её в объект
